...
OPTION(filter,bool,true,0,1,"filtered positive reduct") \
...
#   undef OPTION
  ...
  struct { double looking, filtering, pruning, simplifying; } time;
  struct {
  ...
  FILE * eventlog;		// JSONL witness event log (or 0).
