...
| 2 | Cluster-count growth in α | **FAIL — inverted** | N_c *decreases* with α at every n (ρ = −0.69…−0.93); maximum cluster counts occur at LOW α (n=24, α=3.0: median 5). The n-trend at fixed shattered-band α is concordant (2→4.5 with n) — growth lives in n, not in α, at these sizes. |
