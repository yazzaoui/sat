# S2 plateau-structure results index

| Phase | Question | Document | Verdict |
|---|---|---|---|
| Registration | Definitions frozen, feasibility measured, bars set | [S2-registration](docs/S2-registration.md) | Committed pre-run; awaiting lead approval before probes |
